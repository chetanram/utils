...
import com.agc.lottery.Models.User;
...
public class PrefUtils {
    ...
    public static boolean saveUser(Context context, String key, User.UserDetail user) {
        final SharedPreferences.Editor editor = getPreferences(context).edit();
    ...
    public static User.UserDetail getUser(Context context, String key) {
        final SharedPreferences prefs = getPreferences(context);

        String str = prefs.getString(key, null);
        if (str != null) {
            User.UserDetail user = new Gson().fromJson(str.toString(), User.UserDetail.class);
            return user;
        } else {
            return null;
        }
