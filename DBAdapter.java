...
public class DBAdapter {
    ...
    public boolean updateScreenSaver(int id, int status, long timeout, long interval) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(STATUS, status);
        initialValues.put(TIMEOUT, timeout);
        initialValues.put(INTERVAL, interval);
        return db.update(TBL_SCREEN_SAVER, initialValues, _ID + "=" + id, null) > 0;
    }
    ...
    public boolean updateImageBasedOnImageLocation(String oldFileName, String currentFullPath, String newFileName) {
        ContentValues initialValues = new ContentValues();
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            Log.e("CREATE_TBL_SCREEN_SAVER", CREATE_TBL_SCREEN_SAVER);
