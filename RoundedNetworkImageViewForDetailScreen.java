...
public class RoundedNetworkImageViewForDetailScreen extends NetworkImageView {
//    private int borderColor = getResources().getColor(R.color.profile_pic_border_color);
//    private int borderWidth = (int) Common.convertDpToPixel(5,getContext());//15;
    ...
    private int secondBorderWidth = (int) Common.convertDpToPixel(2,getContext());//10;
    private Bitmap mLocalBitmap;
    private boolean mShowLocal;
    private int top, right, left, bottom;

    public RoundedNetworkImageViewForDetailScreen(Context context) {
        super(context);
    }

    public RoundedNetworkImageViewForDetailScreen(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundedNetworkImageViewForDetailScreen(Context context, AttributeSet attrs, int defStyle) {
