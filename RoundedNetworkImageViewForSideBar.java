...
public class RoundedNetworkImageViewForSideBar extends NetworkImageView {
//    private int borderColor = getResources().getColor(R.color.col_slide_profile_image_top);
//    private int borderWidth = (int) Common.convertDpToPixel(5,getContext());//15;
    private int secondBorderColor = getResources().getColor(R.color.col_slide_profile_image_in);
    private int firstBorderColor = getResources().getColor(R.color.col_slide_profile_image_top);
    private int firstBorderWidth = (int) Common.convertDpToPixel(5,getContext());//10;
    private int secondBorderWidth = (int) Common.convertDpToPixel(5,getContext());//10;
    private Bitmap mLocalBitmap;
    private boolean mShowLocal;
    private int top, right, left, bottom;

    public RoundedNetworkImageViewForSideBar(Context context) {
        super(context);
    }

    public RoundedNetworkImageViewForSideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoundedNetworkImageViewForSideBar(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawCircle(getWidth() / 2, getHeight() / 2, (radius - getResources().getDimension(R.dimen.radius_profile)), paint);
//
...
//        paint.setShader(s);
//        canvas.drawCircle(getWidth() / 2, getHeight() / 2, (radius - borderWidth - 0.5f) - getResources().getDimension(R.dimen.radius_profile), paint);
